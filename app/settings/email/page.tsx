    ...
    return (
        <div className="min-h-screen p-4 md:p-8 pb-20 bg-gray-50 dark:bg-[#0b0a12] font-poppins">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 h-[85vh]">
                ...
                <SettingsSidebar activePage="email" />
                ...
                <div className="flex-1 bg-white dark:bg-[#11101d] rounded-[20px] shadow-2xl overflow-y-auto p-8 border border-gray-100 dark:border-gray-800 relative">
                    ...
                    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-500">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Ganti Email</h2>
                            <p className="text-gray-500 dark:text-gray-400">Perbarui alamat email akun anda</p>
                        </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            disabled
                                            className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-gray-200 dark:bg-[#25233b] border-2 border-transparent text-gray-500 dark:text-gray-400 font-medium cursor-not-allowed"
                                        />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            className="w-full pl-4 pr-4 py-3.5 rounded-xl bg-white dark:bg-[#11101d] border-2 border-transparent focus:border-blue-500 outline-none transition-all font-medium text-gray-700 dark:text-white shadow-sm"
                                        />
                                    </div>
                                    <p className="text-xs text-gray-500 mt-1">Demi keamanan, masukkan password anda untuk mengubah email.</p>
                                </div>
                            </div>
